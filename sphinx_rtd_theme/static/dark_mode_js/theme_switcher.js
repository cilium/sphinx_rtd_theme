...
$(document).ready(() => {
  ...
  $('footer').html(
    $('footer').html() +
      '<a href="https://github.com/MrDogeBro/sphinx_rtd_dark_mode">Dark theme</a> inspired by <a href="http://mrdogebro.com">MrDogeBro</a>.'
  );
});
...
const switchTheme = () => {
  ...
  switchPygments(localStorage.getItem('theme'));
};
